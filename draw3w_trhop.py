...
def DrawTogether(date: str):
    ...
    p1, = ax1.plot(WVR_time,WVR_ZTD,label='WVR')
    p2, = ax1.plot(GPS_time,GPS_ZTD,label='GPS')
    p3  = ax1.scatter(RT_time,RT_ZTD,color='#238b45',label='RT',marker='^')
    ...
    ax2_l1, = ax2.plot(WVR_time, [i*100 for i in WVR_RHO], label='Relative humidity')
    ...
    ax3 = ax2.twinx()
    ax2_l2, = ax3.plot(WVR_time,WVR_T,color='#ff7f0e',label='Temperature')
